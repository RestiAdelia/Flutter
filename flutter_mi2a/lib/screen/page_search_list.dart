...
class _PageSearchListState extends State<PageSearchList> {
  ...
  List<String> filterData = []; //untk list filter
  TextEditingController txtCari = TextEditingController(); //search field
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Search List"), backgroundColor: Colors.green),
      body: Padding(
            ...
            isCari
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(title: Text(listDevice[index]));
                },
              ),
            )
                : CreateListView(),
  ...
  Widget HasilSearch() {
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(title: Text(filterData[index]));
        },
      ),
    );
  }
